                        ...
                        Row(
                            ...
                            modifier = Modifier
                                ...
                                .clickable {
                                    Toast
                                        .makeText(
                                            applicationContext, "Khabrain News", Toast.LENGTH_SHORT
                                        )
                                        .show()
                                },
                        ) {
                            Image(
                                painter = painterResource(id = R.drawable.coaching_classes),
                            ...
                            Column(
                                ...
                                Text(
                                    text = "Coaching Classes for 1st year students has been started.",
                                    color = Color.Black,
                                    fontSize = 15.sp,
                                    fontFamily = fontFamily,
